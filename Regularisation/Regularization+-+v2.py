...
def forward_propagation_with_dropout(X, parameters, keep_prob = 0.5):
    ...
    A2 = relu(Z2)
    ###
    D2 =  np.random.randn(A2.shape[0], A2.shape[1]) < keep_prob                                     # Step 1: initialize matrix D1 = np.random.rand(..., ...)                                       # Step 2: convert entries of D1 to 0 or 1 (using keep_prob as the threshold)
